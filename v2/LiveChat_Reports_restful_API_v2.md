...
| Agent Performance | Metrics in this reports are available either in the Workload or Efficiency report. | Yes
| Rating | Yes | Yes
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/chatVolume? timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/visits? timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=halfHourDistribution"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/chatSource? timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00& group=24*7Distribution"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/chatSource/requestPage?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/queue?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/waitTime?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
Shows the number of chats that were transferred to another agent or department within a specific time period.
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/chatTransfer?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=departmemt"
```
...
Shows data on how long your live chat team or a specific department was online for within a specific time period.
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/availability?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=agent"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/agentPerformance?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/agentPerformance?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/workload?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
Shows the average response time, wait time and chat time for each agent, department, as well as the your live chat team as a whole.
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/efficiency?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/rating?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=agent"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/postChatSurvey?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/prechatSurvey?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&filterName=campaign&filterValue=1"
```
...
| `fieldId` | the id of the field
| `fieldName` | the name of the field
| `groups` | a list of option groups for the **category** field, `name` is the display text of the group name and `options` contains the sub options
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/wrapup/survey?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/wrapup/completion?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/conversions?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=day"
```
...
Shows the number of manual invitations sent by agents within a specific time period.
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/manualInvitation?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=agent"
```
...
Shows the number of auto invitations sent as well as the number of auto-invitations accepted by visitors within a specific time period.
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/autoInvitation?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=autoInvitation"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/offlineMessage?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00&group=campaign"
```
...
Shows how many times and by how many agents each canned message was used within a specified time period.
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/cannedMessage?timeFrom=2017-12-01T00:00:00&timeTo=2018-01-01T00:00:00&timezone=+08:00"
```
...
Shows the current number of chats, visitors, available agents, queue length, etc.
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/rightnow"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/realtime/today/customMetrics?timezone=+08:00"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/realtime/agents?timezone=+08:00&filterName=department&filterValue=1"
```
...
```bash
curl -u tester@comm100.com:ef43f9362aac4f60ad428cb4d072f2c8 -X GET "https://hosted.comm100.com/api/v1/livechat/reports/realtime/queue?timezone=+08:00"
```
