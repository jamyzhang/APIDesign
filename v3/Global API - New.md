...
### Agent SSO Object
  ...
  | `createdTime` | datetime  | yes | N/A | | API does not need to provide it. //人家文档上都写了API 不需要提供了,你还提供.... |
  | `createdBy` | [Agent](#Agent-Object)  | yes | N/A | | Which agent create the current item. API does not need to provide it. //同上 |
...
### Visitor SSO Object
  ...
  | `fieldMappings` | [Agent](#Field-Mapping-Object)[] //好像写的不对吧  | | N/A | N/A | | |
  | `perCampaign` | [Agent](#Visitor-SSO-Campaign-Object)[] //好像写的不对吧 | yes | N/A | N/A | | |
