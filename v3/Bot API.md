...
|`responses`| [Response](#response-object)[] | yes | no | yes | | an array of [Response](#response-object) object. Available only when responses are included |
...
```
curl -H "Content-Type: application/json" 
-X GET https://domain.comm100.com/api/v3/ia/chatbot/bots/f9928d68-92e6-4487-a2e8-8234fc9d1f48?include=greetingMessageInChannels,noAnswerMessageInChannels,messageAfterSeveralConsecutivePossibleAnswersInChannels
```
Response
```json
HTTP/1.1 200 OK
...
Query string
  ...
  | Name  | Type | Required | Default | Description |     
  | - | - | - | - |  - | 
  | `include` | string | no  | | Available value: `responses`  | 
...
|`authenticationRequest`| [AuthenticationRequest](#AuthenticationRequest-Object)| yes |  no |no | |[AuthenticationRequest](#AuthenticationRequest-Object) object. Available only when authenticationRequest is included.|
|`locationRequest`| [LocationRequest](#LocationRequest-Object)| yes | no |no | | [LocationRequest](#LocationRequest-Object) object. Available only when locationRequest is included.|
| `form` | [Form](#Form-Object)  | yes | no | no |  |[Form](#Form-Object) object. Available only when form is included. |
| `prompts` | [Prompt](#Prompt-Object)[]  | yes | no | no | | an array of  [Prompt](#Prompt-Object) object. Available only when prompts are included. |
...
Using curl
```
curl -H "Content-Type: application/json" -X GET https://domain.comm100.com/api/v3/ia/chatbot/intents/1487fc9d-92e6-4487-a2e8-92e68d6892e6?include=category,questions,answerInChannels
```
Response
```Json
  HTTP/1.1 200 OK
...

  {
    ...
    "answerInChannels":[  // include answerInChannels
      {
        "id":"4487fc9d-92e6-4487-a2e8-92e68d6892e6",
        "channel":"Default",
        "responses": [
...
Query string
  ...
  | Name  | Type | Required | Default | Description |     
  | - | - | - | - |  - | 
  | `include` | string | no  | | Available value: `responses`, `locationRequest`, `form`, `prompts`, `authenticationRequest`  | 
...
Using curl
```
curl -H "Content-Type: application/json" -X GET https://domain.comm100.com/api/v3/ia/chatbot/answerInChannels/1487fc9d-92e6-4487-a2e8-92e68d6892e6?include=responses,locationRequest,form,prompts,authenticationRequest
```
Response
```Json
  HTTP/1.1 200 OK
...
Using curl
```
curl -H "Content-Type: application/json" -X GET https://domain.comm100.com/api/v3/ia/chatbot/entities/aaa8sc9d-92e6-4487-a2e8-92e68d6892e6?include=keywords
```
Response
```json
  HTTP/1.1 200 OK
...
Using curl
```
curl -H "Content-Type: application/json" -X GET https://domain.comm100.com/api/v3/ia/chatbot/smartTriggers/dawfe21d-92e6-4487-a2e8-92e68d6892e6?include=conditions,actions
```
Response
```json
  HTTP/1.1 200 OK
...
Using curl
```
curl -H "Content-Type: application/json" -X GET https://domain.comm100.com/api/v3/ia/chatbot/quickreplies/dawfe21d-92e6-4487-a2e8-92e68d6892e6?include=items
```
Response
```json
  HTTP/1.1 200 OK
